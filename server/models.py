...
class Employee(db.Model):
    ...
    projects = association_proxy('assignments', 'project', creator=lambda project: Assignment(project=project))
...
class Project(db.Model):
    ...
    employees = association_proxy('assignments', 'employee', creator=lambda employee: Assignment(employee=employee))
